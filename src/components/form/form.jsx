...
export default function Form({ cvc, setCvc, cardNum, setCardNum, month, setMonth, year, setYear, cardholder, setCardholder }) {
    ...
    return (
        <div className='form-area'>
            ...
            <div className='form'>
                ...
                <button type="submit" onClick={handleSubmit} className='btn confirm-btn'>Confirm</button>
            </div>) : <ThankYou toggler={toggler} setToggler={setToggler} className='form'/>}
        </div>
    )
}
